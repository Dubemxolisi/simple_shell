 ...
 * @info: the structure containing potential arguments that are used
...
/**
 * _setenv - it intialize a new environment variable
 * or modify an existing one
 * @info: the structure containing protential arguments
 * used to maintain constant function prototype
 * @var: the is the string env var property

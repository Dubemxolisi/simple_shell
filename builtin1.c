 ...
 * @str: its the string alias
 * Return: Always 0 on success and error for 1
 */
...
/**
 * set_alias - its sets alias to string
 * @info: parameter struct
 ...
 *Return: Always 0 on success and 1 if the is a error
*/
...
/**
* _myalias - it mimics the alias buitin (man alias)
* @info: it the structure containing potential arguments
